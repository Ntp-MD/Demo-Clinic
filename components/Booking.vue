...
<style scoped>
.booking { background-color: var(--main-color-2); }
...
.booking__desc { font-size: var(--font-md); color: var(--font-color2); line-height: 1.8; margin-bottom: var(--spacing-xl); }

.booking__contact-list { display: flex; flex-direction: column; gap: var(--spacing-lg); margin-bottom: var(--spacing-xl); }

.booking__contact-item { display: flex; align-items: flex-start; gap: var(--spacing-md); }
...
.booking__contact-label { font-size: var(--font-xs); color: var(--font-color3); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 3px; }
.booking__contact-value { font-size: var(--font-sm); color: var(--font-color1); font-weight: 400; }

.booking__hours { background-color: var(--main-color-1); border-radius: var(--radius-md); padding: var(--spacing-lg); }

.booking__hours-title { font-family: var(--font-display); font-size: var(--font-lg); font-weight: 500; color: var(--font-color1); margin-bottom: var(--spacing-md); }

.booking__hours-grid { display: flex; flex-direction: column; gap: var(--spacing-sm); }
.booking__hours-row { display: flex; justify-content: space-between; align-items: center; }
.booking__hours-days { font-size: var(--font-sm); color: var(--font-color2); }
.booking__hours-time { font-size: var(--font-sm); font-weight: 500; color: var(--accent-primary); }
...
.booking__title-em { font-style: italic; color: var(--accent-primary); }
.booking__form-title { font-family: var(--font-display); font-size: var(--font-2xl); font-weight: 600; color: var(--font-color1); margin-bottom: var(--spacing-xs); }
.booking__form-subtitle { font-size: var(--font-sm); color: var(--font-color3); margin-bottom: var(--spacing-xl); }
.booking__form { display: flex; flex-direction: column; gap: var(--spacing-md); }

.booking__form-submit { width: 100%; margin-top: var(--spacing-sm); padding: 16px; font-size: var(--font-sm); letter-spacing: 1px; }
.booking__form-submit:disabled { background-color: var(--accent-success); border-color: var(--accent-success); cursor: not-allowed; }
